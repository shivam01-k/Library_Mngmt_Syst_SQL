/* 1. creating new database with the name Lib_mngmt_system*/
create database lib_mngmt_sys;
use lib_mngmt_sys;

/*2. Creating new table with name tbl_category consisting of category_id & 
category_name*/
...
/* 3. Creating new table with name tbl_publisher consisting of publisher_id, 
pubisher_name, publication_language & publication_type*/
...
/* 4. Creating new table with name tbl_location consisting of location_id, shelf_no, 
shelf_name & floor_no*/
...
/* 5. Creating new table with name tbl_author consisting of author_id, first_name & 
last_name*/
...
/* 6. Creating new table with name tbl_book consisting of book_id, isbn_code,
book_title, category_id,publisher_id, publication year, book edition, copies_total, 
copies_available & location_id*/
...
/* 7. Creating new table with name tbl_book_author consisting of book_id & author_id*/
...
/* 8. Creating new table with name tbl_member_status consisting of active_status_id, 
account_type, account_status, membership_start_date & membership_end_date*/
...
/* 9. Creating new table with name tbl_member consisting of member_id, first_name, 
last_name, city, mobile_no, email_id, date_of_birth & active_status_id*/
...
constraint fk_active_status_id foreign key (active_status_id) references
tbl_member_status(active_status_id)
);

/* 10. Creating new table with name tbl_library_staff consisting of issue_by_id, 
staff_name & staff_designation*/
...
/* 11. Creating new table with name tbl_book_issue consisting of issue_id, book_id, 
member_id, issue_date, return_date, issue_status & issued_by_id*/
...
constraint fk_issue_issued_by_id foreign key(issued_by_id) references
tbl_library_staff(issue_by_id)
);

/* 12. Creating new table with name tbl_fine_due consisting of fine_id, member_id,
...
/* 13. Creating new table with name tbl_fine_payment consisting of fine_payment_id, 
...
/* 14. Creating new table with name tbl_book_request_status consisting of 
...
/* 15. Creating new table with name tbl_book_request consisting of request_id, 
book_id, member_id, request_date & available_status_id*/
...
constraint fk_request_available_status_id foreign key(available_status_id) references
tbl_book_request_status(available_status_id)
);
...
values('student','active','2018-06-15','2020-06-15'),
('student','active','2019-07-15','2021-07-15'),
('student','inactive','2016-05-10','2017-05-10'),
('student','inactive','2015-04-15','2016-04-15'),
('professional','active','2020-05-20','2022-05-20'),
('professional','active','2018-07-25','2022-07-25'),
('professional','inactive','2015-04-10','2018-04-10'),
('professional','inactive','2016-04-15','2016-10-15'),
('staff','active','2020-06-12','2022-06-12'),
('staff','active','2020-07-18','2022-07-18'),
('staff','inactive','2015-05-21','2016-05-21');
...
values('A','Kumar','Delhi','9999999999','a@xyz.com','1996-04-01',1),
('B','Kumar','Delhi','9999999999','b@xyz.com','1990-02-21',5),
('C','Kumar','Noida','9999999999','c@xyz.com','2000-10-25',3),
('A','Singh','Noida','9999999999','as@xyz.com','2002-11-10',2),
('B','Singh','Noida','9999999999','bs@xyz.com','1985-02-15',4),
('B','Singh','Noida','9999999999','bs@xyz.com','1985-03-05',6),
('C','Singh','Delhi','9999999999','cs@xyz.com','1990-08-30',7),
('X','Patel','Delhi','9999999999','x@xyz.com','1990-01-13',9),
('Y','Arora','Delhi','9999999999','y@xyz.com','1985-09-12',10),
('Z','Khanna','Delhi','9999999999','z@xyz.com','1970-04-25',11);
...
values(7, 1, '2022-09-10', '2022-09-25', 'overdue', 1),
...
select count(case when account_status='active' then 1 else null end ) as active_members,
       count(case when account_status='inactive' then 1 else null end ) as inactive_members
 from tbl_member m
join tbl_member_status ms on m.active_status_id=ms.active_status_id;
